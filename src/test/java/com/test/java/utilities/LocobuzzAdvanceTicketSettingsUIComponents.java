...
//agency(heading,active button)
			WebElement agencyImage=driver.findElement(By.xpath("(//img[@src='assets/images/agentimages/sample-image.svg'])[1]"));
...
//csd(heading,active button)
			WebElement csdImage=driver.findElement(By.xpath("(//img[@src='assets/images/agentimages/sample-image.svg'])[2]"));
...
//brand(heading,active button)
			WebElement brandImage=driver.findElement(By.xpath("(//img[@src='assets/images/agentimages/sample-image.svg'])[3]"));
