...
//add column
			...
			columnName.sendKeys("Agent information");
...
// add parameter
			...
			WebElement selectParameter1 = driver
					.findElement(By.xpath("//span[@class='mat-option-text' and text()='Feedback Rating ']"));
			...
			WebElement arrow1 = driver.findElement(By.xpath(
					"(//h3[contains(text(),'Create formula')]//following::div[contains(@class,'mat-select-value')])[3]"));
...
//search
			...
			search1.sendKeys("Agent information");
