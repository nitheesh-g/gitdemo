...
//Click open details
		...
		phno.clear();
		Thread.sleep(2000);
		WebElement aadhar = driver.findElement(By.xpath("(//input[contains(@class,'mat-input-element mat')])[24]"));
		((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView(true);", aadhar);
		aadhar.clear();
		Thread.sleep(2000);
	    WebElement pincode = driver.findElement(By.xpath("(//input[contains(@class,'mat-input-element mat')])[29]"));
		((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView(true);", pincode);
		pincode.sendKeys("123456");
		Thread.sleep(2000);
		WebElement numdemo = driver.findElement(By.xpath("(//input[contains(@class,'mat-input-element mat')])[28]"));
...
//Click open details
		...
		((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView(true);", aadhar);
		Thread.sleep(5000);
		WebElement TransactionID = driver.findElement(By.xpath("(//input[contains(@class,'mat-input-element mat')])[21]"));
		((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView(true);", TransactionID);
	    Thread.sleep(5000);
	    TransactionID.sendKeys("123456789876543");
		WebElement update = driver.findElement(By.xpath("(//span[contains(text(),'Update')])"));
		js.executeScript("arguments[0].click()", update);
		Thread.sleep(2000);
		WebElement arrow = driver.findElement(By.xpath("(//mat-icon[contains(text(),'arrow_back')])[3]"));
		...
		Thread.sleep(2000);
		WebElement tranID = driver.findElement(By.xpath("(//span[contains(text(),'Transaction ID')])"));
...
//Search by Field Name Field	
			...
			Searchbyfieldtx.sendKeys("Komal");
			Thread.sleep(3000);
...
// Enter a Field name 
			...
			Actions actions = new Actions(driver);
	        Action action = actions.sendKeys(enterfieldname, "Komal Text Demo").build();
	        action.perform();
	        Thread.sleep(3000);
...
//Enter Regular Expression
			...
			WebElement Textbox=driver.findElement(By.xpath("(//input[@placeholder='Enter regular expression'])"));
...
//Edit Old Details			
			WebElement edit=driver.findElement(By.xpath("(//mat-icon[contains(text(),'edit')])[3]"));
...
//Delete all Personal Details Field
			...
			Thread.sleep(3000);
			WebElement confirmdelete1=driver.findElement(By.xpath("(//span[contains(@class,'mat-ripple mat-button-ripple')])[5]"));
...
//Tweet		
		...
		String twitterDynamicMessage = " @TShrivatri\r\n"
				+ " \r\n"
				+ "Komal\r\n"
