...
//Verify Newly added Google Alert Account Configuration Details			
			...
			WebElement Link1 = driver.findElement(By.xpath("(//span[contains(text(),'https://www.google.com/alerts#1:4')])"));
			...
			WebElement pausebutton1 = driver.findElement(By.xpath("(//span[contains(@class,'mat-button-wrapper')])[10]"));
			Thread.sleep(3000);
...
//Verify Newly added Google Alert Account Configuration Details			
			...
			WebElement Link = driver.findElement(By.xpath("(//span[contains(text(),' https://www.google.com/alerts#2:2 ')])"));
			System.out.println("Link of Google Alert profile Configuration is:"+Link.getText());
			//WebElement ConfStatus = driver.findElement(By.xpath("(//span[contains(text(),'Owned')])[3]"));
			//System.out.println("Time of twitter profile Configuration is:"+ConfStatus.getText());
			WebElement Delete = driver.findElement(By.xpath("(//span[contains(@class,'mat-button-wrapper')])[12]"));
			WebElement pausebutton = driver.findElement(By.xpath("(//span[contains(@class,'mat-button-wrapper')])[13]"));
			Thread.sleep(3000);
...
//Stop Fetchiong Mensions
			WebElement Pause2 = driver.findElement(By.xpath("(//mat-icon[contains(text(),'pause')])[4]"));
			...
			Thread.sleep(3000);
			WebElement Pause1 = driver.findElement(By.xpath("(//mat-icon[contains(text(),'pause')])[3]"));
