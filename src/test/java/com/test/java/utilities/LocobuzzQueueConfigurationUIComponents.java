...
//queue management information
			...
			WebElement info = driver.findElement(By.xpath("//p[contains(@class,'mb-0 mt-6 text__light--sm')]"));
...
//teams
			...
			WebElement brandTeam = driver.findElement(By.xpath("(//span[contains(text(),'Brand')])[2]"));
