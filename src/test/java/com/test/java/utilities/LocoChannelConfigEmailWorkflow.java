...
//Verify Incoming Email Configuration
			...
			Thread.sleep(3000);
			WebElement AccountPage = driver.findElement(By.xpath("(//div[contains(text(),'Komal')])[2]"));
...
//Verify  Outgoing Email Configuration
			...
			Thread.sleep(3000);
			WebElement OutAccountUser = driver.findElement(By.xpath("(//div[contains(text(),'Komal')])[3]"));
			...
			Thread.sleep(3000);
			WebElement Edit = driver.findElement(By.xpath(" (//img[@src='assets/images/account/edit.svg'])[3]"));
			...
			WebElement Ppausebutton = driver.findElement(By.xpath(" (//mat-icon[contains(text(),'pause')])[3]"));
			Thread.sleep(3000);
			if(Edit.isDisplayed() && Delete.isDisplayed() && Reathorize.isDisplayed() && Ppausebutton.isDisplayed() && Footerbutton.isDisplayed())
			{
...
//Delete Incoming and Outgoing Configured Account			
			WebElement Odelete = driver.findElement(By.xpath(" (//mat-icon[contains(text(),'delete')])[3]"));
