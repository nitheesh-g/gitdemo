...
//select the first attribute
			...
			Thread.sleep(3000);
			WebElement selectChannel = driver.findElement(By.xpath("(//span[contains(text(),'Twitter')])[2]"));
...
//select brand
			...
			searchBrand.sendKeys("akhil");
			//js.executeScript("arguments[0].click()", searchBrand);
			Thread.sleep(3000);
			
			WebElement selectBrand=driver.findElement(By.xpath("//span[@class='ml-11 font-weight-500' and text()='Akhil Brand']"));
			selectBrand.click();
			//js.executeScript("arguments[0].click()", selectBrand);
			Thread.sleep(3000);
...
//select the brand
			...
			searchBrand1.sendKeys("akhil");
			WebElement brand = driver.findElement(By.xpath("(//span[contains(text(),'Akhil Brand')])"));
			js.executeScript("arguments[0].click()", brand);
			Thread.sleep(2000);
