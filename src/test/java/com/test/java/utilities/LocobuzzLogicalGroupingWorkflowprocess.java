...
//Create Logical Grouping tab name	and Information	
			...
			WebElement LGHeading=driver.findElement(By.xpath("(//p[contains(text(),'Create Logical Grouping')])"));
			WebElement LGInformation=driver.findElement(By.xpath("(//p[contains(text(),'Create Logical Grouping')])//following::p[1]"));
...
//Select Brand Textbox
			...
			Thread.sleep(3000);
			WebElement brand3=driver.findElement(By.xpath("(//span[contains(text(),'test-cello')])"));
			js.executeScript("arguments[0].click()", brand3);
			Thread.sleep(3000);
			WebElement brand4=driver.findElement(By.xpath("(//span[contains(text(),'mobile Test')])"));
