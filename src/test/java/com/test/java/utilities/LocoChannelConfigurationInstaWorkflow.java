...
//Add Public Twitter Account
			...
			Thread.sleep(3000);
			WebElement PublicInstaHandletxbx=driver.findElement(By.xpath("(//input[@type='text'])[2]"));
...
//Verify Owned Insta Account Configuration			
			...
			Thread.sleep(3000);
			WebElement AccConfTime = driver.findElement(By.xpath("(//div[contains(@class,'colored__grey--light text__sm')])[4]"));
			System.out.println("Time of Insta profile Configuration is:"+AccConfTime.getText());
			Thread.sleep(3000);
			WebElement ConfStatus = driver.findElement(By.xpath("(//span[contains(text(),'Owned')])[4]"));
			System.out.println("Configured Status  of Insta profile is:"+ConfStatus.getText());
			Thread.sleep(3000);
			
			WebElement Delete = driver.findElement(By.xpath("(//button[contains(@class,'mat-focus-indicator btnDelete')])[4]"));
			WebElement pausebutton = driver.findElement(By.xpath("(//button[contains(@class,'mat-focus-indicator mat-stroked-button mat-button-base btnPause')])[4]"));
			Thread.sleep(3000);
...
//Verify Public Twitter Account Configuration			
			/*WebElement PAccountHandle = driver.findElement(By.xpath("(//div[contains(text(),'Locobuzz')])"));
			System.out.println("Name of twitter profile Configuration is:"+PAccountHandle.getText());
			WebElement PAccConfTime = driver.findElement(By.xpath("(//div[contains(@class,'colored__grey--light text__sm')])[3]"));
			...
			WebElement Ppausebutton = driver.findElement(By.xpath("(//button[contains(@class,'mat-focus-indicator mat-stroked-button mat-button-base btnPause')])[3]"));
			Thread.sleep(3000);
