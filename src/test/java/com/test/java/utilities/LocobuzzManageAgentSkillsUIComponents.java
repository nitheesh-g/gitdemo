...
//manual tab
			WebElement manualImage = driver
					.findElement(By.xpath("(//img[@src='assets/images/account-profile/keyword.svg'])[5]"));
...
//keyword preview
			...
			WebElement previewTab=driver.findElement(By.xpath("//div[@class='textarea-featured__block mt-10 mb-0 config-skill__preview--textarea border__light-grey']"));
...
//link existing category button
			WebElement image=driver.findElement(By.xpath("(//img[@src='assets/images/account-profile/category.svg'])[7]"));
