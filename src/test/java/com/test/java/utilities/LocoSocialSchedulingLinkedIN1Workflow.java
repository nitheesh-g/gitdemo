...
//Select 4 Images
	...
	Thread.sleep(1000);
	WebElement addimages2=driver.findElement(By.xpath("(//span[contains(@class,'media-gallery')])[7]"));
    js.executeScript("arguments[0].click()", addimages2);
	Thread.sleep(1000);
	WebElement addimages3=driver.findElement(By.xpath("(//span[contains(@class,'media-gallery')])[2]"));
    js.executeScript("arguments[0].click()", addimages3);
	Thread.sleep(1000);
	WebElement addimages4=driver.findElement(By.xpath("(//span[contains(@class,'media-gallery')])[10]"));
	...
	WebElement addimages6=driver.findElement(By.xpath("(//span[contains(@class,'media-gallery')])[6]"));
