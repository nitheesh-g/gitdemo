...
//Select Brand Field
			...
			Thread.sleep(3000);			
//select Brand						
			WebElement selectbrand=driver.findElement(By.xpath("(//span[contains(text(),'kalyan')])"));
...
//Brand logo
			...
			driver.findElement(By.xpath("(//img[@src='https://s3.amazonaws.com/locobuzz.socialimages/LocoBuzzBrandLogos/reliancejiodb/02b192ec-c0da-4e16-b63a-2035f2a2ad2a.png'])"));
...
//Brand Name
			WebElement brandname=driver.findElement(By.xpath("(//p[contains(text(),'kalyan')])"));
...
//Time Information
			WebElement updatedtime=driver.findElement(By.xpath("(//p[@class='mb-0 text__sub--sm'])"));
...
//More field
			WebElement More=driver.findElement(By.xpath("(//mat-icon[@class='mat-icon notranslate material-icons mat-icon-no-color'])[2]"));
			if (More.isDisplayed()) {
...
//Toogle button
		    ...
		    Thread.sleep(5000);		
		    System.out.println("Approver setting on for kalyan brand");
...
//Deleting one user by edit field
			WebElement deleteuser=driver.findElement(By.xpath("(//mat-icon[contains(text(),'highlight_off')])[3]"));
...
//Delete field
//More field
			WebElement More1=driver.findElement(By.xpath("(//mat-icon[@class='mat-icon notranslate material-icons mat-icon-no-color'])[2]"));
