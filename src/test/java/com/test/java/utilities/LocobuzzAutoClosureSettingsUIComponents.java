...
//Add reminder message
			WebElement addReminderHeading = driver.findElement(By.xpath("//h3[@class='modal__title text-capitalize']"));
			WebElement message1 = driver.findElement(By.xpath("//p[@class='font-size-12 mb-0 line-height-1.25']"));
...
//add messages
			...
			WebElement infomation = driver.findElement(By.xpath("(//p[@class='mb-12'])"));
...
//Add reminder message
			...
			WebElement message2 = driver.findElement(By.xpath("//p[@class='font-size-12 mb-0 line-height-1.25']"));
...
//add autoclosure messages 
			...
			WebElement addAutoClosureInfo=driver.findElement(By.xpath("//p[@class='font-size-12 mb-0 line-height-1.25']"));
...
//add autoclosure messages 
			...
			WebElement addAutoClosureInfo1=driver.findElement(By.xpath("//p[@class='font-size-12 mb-0 line-height-1.25']"));
