...
//search the brand
			...
			WebElement searchCountry=driver.findElement(By.xpath("//input[contains(@class,'mat-input-element mat-form-field-autofill-control material-icons-outlined')]"));
			searchCountry.sendKeys("brazil/east");
			WebElement searchButton=driver.findElement(By.xpath("(//mat-icon[contains(text(),'search')])[3]"));
			js.executeScript("arguments[0].click()", searchButton);
			Thread.sleep(3000);
			
			WebElement selectCountry=driver.findElement(By.xpath("//span[@class='mat-option-text' and text()='(GMT-03:00:00) Brazil/East']"));
