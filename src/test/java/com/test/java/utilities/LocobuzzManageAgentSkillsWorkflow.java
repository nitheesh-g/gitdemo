...
//keyword preview
			WebElement preview=driver.findElement(By.xpath("//span[@class='textarea-featured__input']"));
...
//select categories
			WebElement category=driver.findElement(By.xpath("//span[contains(text(),'Accessories ')]"));
			js.executeScript("arguments[0].click()", category);
			Thread.sleep(3000);
			
			WebElement category1=driver.findElement(By.xpath("//span[contains(text(),'Account Opening ')]"));
			js.executeScript("arguments[0].click()", category1);
			Thread.sleep(3000);
			
			WebElement category2=driver.findElement(By.xpath("//span[contains(text(),'AJIO ')]"));
...
//search field
			...
			search.sendKeys("Account Opening");
			WebElement searchButton1=driver.findElement(By.xpath("(//mat-icon[contains(text(),'search')])[3]"));
			js.executeScript("arguments[0].click()", searchButton1);
			Thread.sleep(3000);
			
			WebElement deletecategory=driver.findElement(By.xpath("//span[contains(text(),'Demo 2 ')]"));
