...
//Verify Owned GPS Account Configuration			
			...
			WebElement Delete = driver.findElement(By.xpath("(//span[contains(@class,'mat-button-wrapper')])[9]"));
			WebElement pausebutton = driver.findElement(By.xpath("(//span[contains(@class,'mat-button-wrapper')])[11]"));
			Thread.sleep(3000);
...
//Verify Public GPS Account Configuration			
			...
			WebElement PDelete = driver.findElement(By.xpath("(//span[contains(@class,'mat-button-wrapper')])[12]"));
			WebElement Edit = driver.findElement(By.xpath("(//span[contains(@class,'mat-button-wrapper')])[13]"));
			WebElement Pause = driver.findElement(By.xpath("(//span[contains(@class,'mat-button-wrapper')])[14]"));
			Thread.sleep(3000);
...
//Delete Owned and Public Configured Account			
			WebElement Odelete = driver.findElement(By.xpath("(//span[contains(@class,'mat-button-wrapper')])[12]"));
