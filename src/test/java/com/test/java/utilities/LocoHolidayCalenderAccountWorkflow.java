...
//Agent Working Days & Hours Field
			...
			Thread.sleep(3000);
			WebElement AsiaKolkata = driver.findElement(By.xpath("(//span[contains(text(),'(GMT+05:30) Asia/Kolkata')])[1]"));
...
//Brand Working Days & Hours Field
			...
			Thread.sleep(5000);
			WebElement SameasAgentBrand = driver.findElement(By.xpath("(//span[contains(text(),'Set same as agent ')])[1]"));
			js.executeScript("arguments[0].click()", SameasAgentBrand);
			Thread.sleep(3000);
//Save Settings	
...
//Calendar Field
			...
			if (Calendarlabel.isDisplayed() && Calendarlink.isDisplayed() && Refreshicon.isDisplayed() && Deleteicon.isDisplayed() && NoEvent.isDisplayed()) {
