...
//copy emails
			...
			searchBrands.sendKeys("sindhuja");
			//js.executeScript("arguments[0].click()", searchBrands);
			Thread.sleep(3000);
			
			WebElement selectBrand=driver.findElement(By.xpath("//span[@class='ml-11 font-weight-500' and text()='Sindhuja V']"));
			selectBrand.click();
...
//select brand
			...
			searchBrand1.sendKeys("sindhuja");
			WebElement brand1 = driver.findElement(By.xpath("(//span[contains(text(),'Sindhuja V')])"));
