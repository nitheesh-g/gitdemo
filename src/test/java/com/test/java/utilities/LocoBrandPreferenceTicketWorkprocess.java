...
//Select Testing123 Category	
			...
			Thread.sleep(3000);
			Actions builder = new Actions(driver);
			WebElement toWebElement = driver.findElement(By.xpath("(//span[contains(text(),'Akhil Kanna')])[1]"));
		    	((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView(true);", toWebElement);
		        Thread.sleep(2000);
		        WebElement fromWebElement = driver.findElement(By.xpath("(//span[contains(text(),'Akhil Kanna')])[2]"));
		        Thread.sleep(2000);
				...
				WebElement toWebElement1 = driver.findElement(By.xpath("(//span[contains(text(),'Akhil Kanna')])[1]"));
			    Thread.sleep(2000);
			    WebElement fromWebElement1 = driver.findElement(By.xpath("(//span[contains(text(),'Akhil Kanna')])[2]"));
			    Thread.sleep(2000);
...
//useractivity
	...
	Thread.sleep(3000);
	WebElement Selectbrand2 = driver.findElement(By.xpath("//span[@class = 'mat-checkbox-label' and contains(text(),'XYZ Brand')]"));
...
//Tweet		
		...
		String twitterDynamicMessage = "@AkhilKa39071441   twitter test" + " " + strDate;
