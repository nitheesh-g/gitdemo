...
//Go To Supervisor Account
			...
			WebElement Continue1 = driver.findElement(By.xpath("(//label[contains(@class,'mat-checkbox-layout')])[2]"));
...
//Verify Public Facebook Account Configuration			
			WebElement PAccountHandle = driver.findElement(By.xpath("(//div[contains(text(),'Locobuzz')])[2]"));
