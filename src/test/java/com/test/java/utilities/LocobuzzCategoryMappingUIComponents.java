...
//catch all category
			...
			WebElement info2 = driver
					.findElement(By.xpath("//div[@class='text__light text__sm line-height-1.5 mt-5']"));
			WebElement catchAllField = driver
					.findElement(By.xpath("(//div[contains(@class,'mat-form-field-wrapper')])[4]"));
			if (catchAllHeading.isDisplayed() && info2.isDisplayed() && catchAllField.isDisplayed()) {
