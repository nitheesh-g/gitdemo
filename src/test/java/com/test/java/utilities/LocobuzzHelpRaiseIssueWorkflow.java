...
//select support category
			WebElement supportCategory=driver.findElement(By.xpath("(//div[contains(@class,'mat-select-value')])[28]"));
...
//subject/summary
			WebElement subject=driver.findElement(By.xpath("(//input[@type='text'])[6]"));
