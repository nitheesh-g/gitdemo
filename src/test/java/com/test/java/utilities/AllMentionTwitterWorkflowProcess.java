...
//mentionid
			...
			WebElement mentionID = driver.findElement(By
					.xpath("(//mat-icon[contains(text(),'message')]//following::span[@class='post__foot--label'])[3]"));
...
//total mention
			...
			WebElement mentions = driver.findElement(By.xpath("(//span[@class='post__foot--label'])[5]"));
...
//ticket id
			...
			WebElement ticketID = driver.findElement(By.xpath(
					"(//mat-icon[contains(text(),'local_activity')]//following::span[@class='post__foot--label'])[4]"));
...
//ticketstatus
			...
			WebElement ticketStatus = driver.findElement(By.xpath("(//span[@class='post__foot--label'])[6]"));
...
// priority
			...
			WebElement priority = driver.findElement(By.xpath("(//span[@class='post__foot--label'])[7]"));
...
// translate
			...
			WebElement languageName = driver.findElement(By.xpath("(//span[@class='post__foot--label'])[7]"));
