...
//Select 4 Images	
	WebElement addimages1=driver.findElement(By.xpath("(//span[contains(@class,'media-gallery')])[10]"));
    js.executeScript("arguments[0].click()", addimages1);
	Thread.sleep(1000);
	WebElement addimages2=driver.findElement(By.xpath("(//span[contains(@class,'media-gallery')])[9]"));
    js.executeScript("arguments[0].click()", addimages2);
	Thread.sleep(1000);
	WebElement addimages3=driver.findElement(By.xpath("(//span[contains(@class,'media-gallery')])[8]"));
    js.executeScript("arguments[0].click()", addimages3);
	Thread.sleep(1000);
	WebElement addimages4=driver.findElement(By.xpath("(//span[contains(@class,'media-gallery')])[7]"));
