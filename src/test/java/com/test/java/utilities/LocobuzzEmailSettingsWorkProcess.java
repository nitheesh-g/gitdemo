...
//Email Address Bcc
			...
			emailBcc.sendKeys("akhil.kannan@locobuzz.com");
			WebElement selectEmail2=driver.findElement(By.xpath("//span[@class='mat-option-text' and contains(text(),' akhil.kannan@locobuzz.com ')]"));
...
//copy content Button
			...
			Thread.sleep(2000);
			searchBrand1.sendKeys("kalyan");
			WebElement selectBrand1=driver.findElement(By.xpath("(//span[contains(text(),'kalyan')])[2]"));
...
//select brand
			...
			searchBrand3.sendKeys("kalyan");
			WebElement brand2=driver.findElement(By.xpath("(//span[contains(text(),'kalyan')])[2]"));
