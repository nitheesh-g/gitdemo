...
//send email
			...
			Thread.sleep(3000);
			sendEmail.sendKeys("kalyan21@gmail.com");
			Thread.sleep(2000);
			WebElement selectEmail1=driver.findElement(By.xpath("//span[contains(text(),' kalyan21@gmail.com ')]"));
...
//copy email destination process
			...
			Thread.sleep(3000);
			destination.sendKeys("akhil brand");
			Thread.sleep(2000);
			WebElement selectBrand=driver.findElement(By.xpath("//span[contains(text(),'Akhil Brand')]"));
			selectBrand.click();
...
//select brand
			...
			searchBrand1.sendKeys("akhil brand");
			WebElement selectBrand1=driver.findElement(By.xpath("//span[contains(text(),'Akhil Brand')]"));
...
//select brand
			...
			searchBrand2.sendKeys("kalyan");
			WebElement selectBrand2=driver.findElement(By.xpath("(//span[contains(text(),'kalyan')])[2]"));
...
//import email button
			...
			Thread.sleep(3000);
			sourceBrand.sendKeys("sindhuja v");
			Thread.sleep(2000);
			WebElement selectBrand3=driver.findElement(By.xpath("//span[contains(text(),'Sindhuja V')]"));
			selectBrand3.click();
...
//select brand
			...
			searchBrand3.sendKeys("sindhuja v");
			WebElement selectBrand4=driver.findElement(By.xpath("//span[contains(text(),'Sindhuja V')]"));
