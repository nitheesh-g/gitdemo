...
//search brand	
		...
		Thread.sleep(5000);		
		WebElement select1=driver.findElement(By.xpath("(//span[contains(text(),'Komal Brand')])[1]"));	
...
//Search brands as Competitors Text Box field
		...
		if(barandsearch.isDisplayed() ) 
			...
			Thread.sleep(3000);
			WebElement barandselect1=driver.findElement(By.xpath("(//span[contains(text(),'HDFC ERGO')])"));		
...
//Brandname
		...
		WebElement newBrandname = driver
				.findElement(By.xpath("(//span[contains(text(),'Komal Brand')])"));
...
//Select  Group textbox
			...
			Thread.sleep(4000);	
			WebElement selectgrp=driver.findElement(By.xpath("(//span[contains(text(),'kalyan')])"));
