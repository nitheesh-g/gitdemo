...
//select brand
			...
			search.sendKeys("testbrand2017");
			WebElement selectBrand = driver.findElement(By.xpath("//span[contains(text(),' TestBrand2017 ')]"));
...
//select profile
			WebElement selectProfile = driver.findElement(By.xpath("//span[contains(text(),'Marol')]"));
