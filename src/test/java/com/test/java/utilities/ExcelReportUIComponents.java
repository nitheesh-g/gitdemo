...
//filter fields
			WebElement field = driver.findElement(By.xpath("(//div[contains(@class,'mat-form-field-wrapper')])[1]"));
			WebElement arrow = driver.findElement(By.xpath("(//div[contains(@class,'mat-select-arrow-wrapper')])[1]"));
			WebElement field1 = driver.findElement(By.xpath("(//div[contains(@class,'mat-form-field-wrapper')])[2]"));
			WebElement arrow1 = driver.findElement(By.xpath("(//div[contains(@class,'mat-select-arrow-wrapper')])[2]"));
			WebElement field2 = driver.findElement(By.xpath("(//div[contains(@class,'mat-form-field-wrapper')])[3]"));
			...
			if (field.isDisplayed() && arrow.isDisplayed() && field1.isDisplayed() && arrow1.isDisplayed()
					&& field2.isDisplayed() && arrow2.isDisplayed() && field3.isDisplayed() && arrow3.isDisplayed()) {
